...
class RedisQueueServiceUnitTest extends AbstractRedisUnitTestContainer {
    ...
    public void pushPopTest() {
        // given
        UserJobPayload payload1 = new UserJobPayload(JobType.USER_ADD, "fake-job-id-111");
        UserJobPayload payload2 = new UserJobPayload(JobType.USER_ADD, "fake-job-id-222");
        ...
        UserJobPayload firstDequeued = queueProvider.dequeue(queueName).orElseThrow();
        ...
        UserJobPayload secondDequeued = queueProvider.dequeue(queueName).orElseThrow();
